...
function App() {
  ...
  return (
    <>
      <H2 label="P2 PART2  INDIVIDUAL ACTIVITY" />
      <hr />
      <div className="container">
        <div className="grid">
          <Image src="/chuuya1.jpg" width={100} height={100} variant="circular" />
          <Image src="/cite.png" width={100} height={100} variant="circular" />
          <Image src="/dazai1.jpg" width={200} height={200} variant="rounded" />
          <Image src="/chuuya.jpg" width={200} height={200} variant="rounded" />
        </div>
      </div>
      <div className="container">
